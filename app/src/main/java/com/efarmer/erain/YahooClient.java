...
public class YahooClient {
    ...
    private static String APPID = "dj0yJmk9WFp0Nmw5WGsyczB1JmQ9WVdrOWJWWk5VekJsTldFbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD1kZQ--";

    public static List<City_results> getCityList(String cityName) {
        List<City_results> result = new ArrayList<City_results>();
    ...
    private static String makeQueryCityURL(String cityName) {
        ...
        return YAHOO_GEO_URL + "/places.q(" + cityName + "%2A);count=" + Bitmap.Config.MAX_CITY_RESULT + "?appid=" + APPID;
    }
